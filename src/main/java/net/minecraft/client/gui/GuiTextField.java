...
public class GuiTextField extends Gui
{
    ...
    private void drawCursorVertical(float p_146188_1_, float p_146188_2_, float p_146188_3_, float p_146188_4_)
    {
        ...
        worldrenderer.func_181662_b(p_146188_1_, p_146188_4_, 0.0D).func_181675_d();
        worldrenderer.func_181662_b(p_146188_3_, p_146188_4_, 0.0D).func_181675_d();
        worldrenderer.func_181662_b(p_146188_3_, p_146188_2_, 0.0D).func_181675_d();
        worldrenderer.func_181662_b(p_146188_1_, p_146188_2_, 0.0D).func_181675_d();
        tessellator.draw();
